...
const starsTag = document.querySelector(".star1 img")
...
const starsTag2 = document.querySelector(".star2 img")
console.log(starsTag)
...
document.addEventListener("scroll",function(){
    ...
    starsTag2.style.transform = `rotate(${distance}deg)`;
 
        }
)


const starsTag3 = document.querySelector(".star3 img")
console.log(starsTag)
...
const starsTag4 = document.querySelector(".ellipse img")
console.log(starsTag)
